export default function Login() {
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center space-y-8">
      ...
      <div className="bg-white p-8 space-y-4 rounded-lg max-w-md w-full shadow">
        ...
        <button className="bg-slate-800 w-full p-2 text-white rounded-md">
          Sign in
        </button>
